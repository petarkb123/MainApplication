(function () {
    ...
    const data = window.__pageDataCreate || {};
    ...
    function getSelectedCards() {
        return Array.from(document.querySelectorAll('.exercise-card')).filter(card => {
            const checkbox = card.querySelector('.exercise-select');
